...
(function () {
    ...
    var ModerationRequestCollection = Backbone.Collection.extend({
        ...
        url : function () {
            return app.SERVER_URL + '/lge/moderation?token='
    ...
    app.Collections.ModerationRequest = new ModerationRequestCollection();
}());